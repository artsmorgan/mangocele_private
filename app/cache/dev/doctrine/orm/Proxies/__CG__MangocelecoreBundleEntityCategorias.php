...
namespace Proxies\__CG__\Mangocele\coreBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Categorias extends \Mangocele\coreBundle\Entity\Categorias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Mangocele\\coreBundle\\Entity\\Categorias' . "\0" . 'titulo', '' . "\0" . 'Mangocele\\coreBundle\\Entity\\Categorias' . "\0" . 'descripcion', '' . "\0" . 'Mangocele\\coreBundle\\Entity\\Categorias' . "\0" . 'createdBy', '' . "\0" . 'Mangocele\\coreBundle\\Entity\\Categorias' . "\0" . 'createdWhen', '' . "\0" . 'Mangocele\\coreBundle\\Entity\\Categorias' . "\0" . 'id');
        }
